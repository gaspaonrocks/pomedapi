...
export default class FormFieldPost extends Component {
  ...
  handleSubmit = () => {
    ...
    return axios.post('http://localhost:12345/posts', post)
      .then(response => {
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        <Form.Field control={TextArea} name="content" label="Content" placeholder="Tell us more..." onChange={this.handleChange} />
